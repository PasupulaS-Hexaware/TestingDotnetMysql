using dotnetMra.Api.Installer;
using dotnetMra.Api.Middleware;
using dotnetMra.Data.Repositories;
...
using System;
using dotnetMra.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;
namespace dotnetMra.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "dotnetMra V1");
        });
