...
dotnetMra.Api.Filters;
using dotnetMra.Business.Installer;
using System;
using OpenTelemetry.Exporter;
using OpenTelemetry.Exporter.OpenTelemetryProtocol;
using OpenTelemetry.Logs;
...
namespace dotnetMra.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetMra API", Version = version + "-" + branch });
        });
